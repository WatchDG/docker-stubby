...
TLS_MIN_VERSION="${STUBBY__TLS_MIN_VERSION:-GETDNS_TLS1_2}"
TLS_MAX_VERSION="${STUBBY__TLS_MAX_VERSION:-GETDNS_TLS1_3}"
...
sed \
  ...
  -e "s/__TLS_MIN_VERSION__/${TLS_MIN_VERSION}/g" \
  -e "s/__TLS_MAX_VERSION__/${TLS_MAX_VERSION}/g" \
